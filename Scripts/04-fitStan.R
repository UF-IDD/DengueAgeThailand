...
parser$add_argument('-stanbase', default = '05-estimates')
parser$add_argument('-stanfile', default = 'Scripts/stan/piecewise.stan')
...
initVals = function(...){
    list(
        omega = runif(1, 1, 2)
        ,theta = runif(1, 1, 2)
        ,lambda = runif(stanInput$len_times + 1, 0, .1)
